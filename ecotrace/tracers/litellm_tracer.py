...
from ecotrace._ecotrace import EcoTrace
from ecotrace.model_repository import models
from ecotrace.tracers.utils import ImpactsOutput, llm_impacts
    ...
    for i, chunk in enumerate(stream):
        ...
        if model_match is not None:
            impacts = llm_impacts(
                ...
                electricity_mix_zone=EcoTrace.config.electricity_mix_zone
            )
