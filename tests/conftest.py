...
def environment():
    ...
    set_envvar_if_unset("AZURE_OPENAI_ENDPOINT", "https://ecotrace-azure-openai.openai.azure.com/openai/deployments/gpt-4o-mini/chat/completions?api-version=2024-08-01-preview")
